 ...
 * @LastEditTime: 2025-08-29 15:32:15
...
// 添加
export const addExpenses = `INSERT INTO expenses (eat, drink, play, glad, tolls, oil, parking, traffic, supermarket, online_shopping, phone_bill, red_packet, create_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, now())`
